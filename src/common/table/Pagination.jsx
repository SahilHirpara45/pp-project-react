...
const Pagination = ({ paginate, style }) => {
  ...
  return (
    <>
      <div
        className="max-sm:hidden flex p-2 justify-end flex-wrap gap-2 items-center"
        style={style}
      >
        {totalPages > 1 && (
          <>
      ...
      <div className="max-sm:flex hidden p-2 justify-end flex-wrap gap-2 items-center mobile-pagination">
        {totalPages > 1 &&
